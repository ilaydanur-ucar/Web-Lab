  ...
  return (
    <section className="min-h-[auto] lg:min-h-[85vh] grid grid-cols-1 lg:grid-cols-2 items-center gap-8 px-4 sm:px-8 py-16 lg:py-24 max-w-[1400px] mx-auto">
      <div className="animate-slide-in-up">
        <p className="text-primary font-semibold mb-2 tracking-wide text-sm uppercase">
          Yazılım Mühendisliği &middot; 3. Sınıf
        </p>
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
          Veri bilimi, makine öğrenmesi ve yapay zekâ odaklı yazılım çözümleri geliştiriyorum.
          Gerçek veri setleri üzerinde tahmin modelleri, anomali tespiti ve akıllı sistemler
          üreterek karmaşık problemlere uygulanabilir çözümler sunuyorum.
        </p>
